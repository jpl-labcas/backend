...
def getProductTypeByName(datasetName):
	
	# retrieve a specific product type by name
	productTypeDict =  fileManaferServerProxy.filemgr.getProductTypeByName(datasetName)
	
	printProductType(productTypeDict)
	
def getProductTypeById(datasetId):
	
	# retrieve a specific product type by name
	productTypeDict =  fileManaferServerProxy.filemgr.getProductTypeById(datasetId)
...
if __name__ == '__main__':
	...
	getProductTypeByName(dataset)
	# or equivalently
	getProductTypeById("urn:edrn:%s" % dataset)

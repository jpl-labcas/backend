...
public class FileManagerUtils {
	...
	public static void cleanupStagingDir(String productTypeName, String datasetId) {
		...
		File stagingDir = getStorageDir(productTypeName, datasetId);
	...
	public static Metadata readCollectionMetadata(String productTypeName) {
        ...
        File stagingDir = getStorageDir(productTypeName);
	...
	/**
	 * Retrieves the top-level directory where data for a given collection must be staged.
	 * @param productTypeName
	 * @param datasetId
	 * @return
	 */
	public static File getStorageDir(final String productTypeName) {
		
		String[] dirs = new String[] {  
				System.getenv(Constants.ENV_LABCAS_STAGING), 
				System.getenv(Constants.ENV_LABCAS_ARCHIVE) 
				};
		
		for (String dir : dirs) {
			File fdir = new File(dir = dir + "/" + productTypeName);
			if (fdir.exists()) {
				return fdir;
			}
		}
	 ...
	 * @return
	 */
	public static File getStorageDir(final String productTypeName, final String datasetId) {
		...
		for (String dir : dirs) {
			...
			File fdir = new File(dir = dir + "/" + datasetId);
			if (fdir.exists()) {
				return fdir;
			}
		}

...
env SOLR_INCLUDE=${LABCAS_HOME}/solr-home/solr.in.sh ./solr start -memory 2g -p 8984 -s $SOLR_HOME -Dsolr.autoSoftCommit.maxTime=1000 -Dsolr.autoCommit.maxTime=10000

...
#######################################
Dashboard6P <- function (Protocol, Sample) {
...
Lab_df <- read.delim(paste(Protocol,"_",Sample,".txt",sep=""))
...
# Make Output Table
MetricsGrid0 <- paste("Protocol =", Protocol, "  Sample =", Sample)
...
ggsave(file=paste(Protocol,"_",Sample,".pdf", sep=""), g, width = 7.5, height = 10)

}
###########################
Dashboard6P(SitePlat, Round)
